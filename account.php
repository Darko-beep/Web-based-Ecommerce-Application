...
<section class="my-5 py-5">
    <div class="row container mx-auto">
        ...
        <div class="clo-lg-6 col-md-12 col-md-12">
            <form action="" id="account-form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="account-password-confirm" name="confirm-password" placeholder="Enter your password" required>
                </div>
